...
namespace EPiServer.Reference.Commerce.Site.Tests.Features.Cart.Services
{
    public class CartServiceTests
    {
        ...
        public CartServiceTests()
        {
            ...
            _referenceConverterMock = new Mock<ReferenceConverter>(new EntryIdentityResolver(synchronizedObjectInstanceCacheMock.Object, new CatalogOptions()), new NodeIdentityResolver(synchronizedObjectInstanceCacheMock.Object, new CatalogOptions()));
